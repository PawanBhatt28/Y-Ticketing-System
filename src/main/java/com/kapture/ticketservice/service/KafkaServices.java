...
public class KafkaServices {
    ...
    public void produceTicket(TicketDTO ticketDTO) {
        ...
        CompletableFuture<SendResult<String, Object>> future = kafkaTemplate.send(Constants.kafkaTopic, ticketDTO);
    ...
    @KafkaListener(topics = Constants.kafkaTopic, groupId = Constants.listenerGroup)
